...
describe("Standard user login", ()=>{
    ...
    it("Perform failed user login", async()=>{
        ...
        await expect(LandingPage.loginErrorMsg).toHaveTextContaining("Epic sadface: Username is required");
        await LandingPage.loginErrorButtonClick();
        await LandingPage.login("rob", "");
        await LandingPage.loginButtonClick();
        await expect(LandingPage.loginErrorMsg).toBeDisplayed();
        await expect(LandingPage.loginErrorButton).toBeDisplayed();
        await expect(LandingPage.loginErrorMsg).toHaveTextContaining("Epic sadface: Password is required");
        await LandingPage.loginErrorButtonClick();
        await LandingPage.login("rob", "holacomo");
        await LandingPage.loginButtonClick();
        await expect(LandingPage.loginErrorMsg).toBeDisplayed();
        await expect(LandingPage.loginErrorButton).toBeDisplayed();
        await expect(LandingPage.loginErrorMsg).toHaveTextContaining("Epic sadface: Username and password do not match any user in this service");
        await LandingPage.loginErrorButtonClick();
    })
    ...
    it("Purchase items from user", async ()=>{
